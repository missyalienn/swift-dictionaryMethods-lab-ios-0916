 ...
 */
var starWarsVillans = ["Darth Vader",
                       "Emperor Palpatine"
 ...
 */
starWarsVillans.append("Kylo Ren")
print(starWarsVillans)
...
// yes, there are "Heroes, Gangsters, Droids, Villians.
...
// Yes, 4 was printed to the console.
...
// Expected: "There are 4 items in the dictionary. 
// Got: "There are 4 items in the dictionary."
...
// returns nil meaning new key was sucessfully added to the dictionary. 

if let starWarsJedi = starWarsCharacters["Jedi"] {
    print("Added jedi key")
}else{
    print("Updated Jedi Key")
}
// expected: "Added Jedi Key" 
// Got: "Added Jedi Key"
/*: question14
...
if let starWarsHunters = starWarsCharacters["Bounty Hunters"]{
 ...
 */
 ...
 if var starWarsJedi = starWarsCharacters["Jedi"] {
...
if let starWarsJedi = starWarsCharacters["Jedi"] {
    for (index, jedi)in starWarsJedi.enumerated(){
        print("\(index + 1). \(jedi)")
}
}

// "Aayla Secura" added as the 4th Jedi
 ...
 */
 ...
 if let starWarsHeroes = starWarsCharacters["Heroes"] {
    for (index, hero) in starWarsHeroes.enumerated() {
        print("\(index + 1). \(hero)")
}
}
